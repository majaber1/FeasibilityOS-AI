...
const services = [
  ...
  { href: "/tools/feasibility", icon: "↗", code: "02", title: { ar: "التحليل المالي", en: "Financial Analysis" }, desc: { ar: "ROI وNPV وIRR وتحليل الحساسية في مساحة قرار واحدة.", en: "ROI, NPV, IRR and sensitivity analysis in one decision workspace." }, tag: { ar: "قرار مالي", en: "Financial decision" } },
