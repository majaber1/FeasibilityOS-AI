...
def test_alembic_single_head_and_revision_chain():
    ...
    assert heads[0] in ("0021_validation_os", "0022_launch_actuals_os", "0023_growth_os", "0024_wave6_integrity", "0025_v2_study_engine", "0026_archetype_assumption_schemas")
